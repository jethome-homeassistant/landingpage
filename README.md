...
discovery information. It also listens on the legacy port 8123 and redirects
all requests there to port 80. From that perspective the landing page is like
a stripped down version of Home Assistant Core.
